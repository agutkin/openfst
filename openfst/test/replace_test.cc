...
class ReplaceTest : public testing::Test {
 protected:
  ...
  void SetUp() override {
    ...
    const std::string g1_name = JoinPath(path, "g1.fst");
    const std::string g2_name = JoinPath(path, "g2.fst");
    const std::string g3_name = JoinPath(path, "g3.fst");
    const std::string g4_name = JoinPath(path, "g4.fst");
    const std::string gout_name = JoinPath(path, "g_out.fst");
    const std::string lattice_name = JoinPath(path, "lattice.fst");
    const std::string path_name = JoinPath(path, "path.fst");
    const std::string r1_name = JoinPath(path, "r1.fst");
    const std::string r2_name = JoinPath(path, "r2.fst");
    const std::string r3_name = JoinPath(path, "r3.fst");
    const std::string r4_name = JoinPath(path, "r4.fst");
    const std::string r5_name = JoinPath(path, "r5.fst");
    const std::string i1_name = JoinPath(path, "i1.fst");
    const std::string i2_name = JoinPath(path, "i2.fst");
    const std::string i3_name = JoinPath(path, "i3.fst");
    const std::string s1_name = JoinPath(path, "s1.fst");
    const std::string s2_name = JoinPath(path, "s2.fst");
    const std::string s3_name = JoinPath(path, "s3.fst");
