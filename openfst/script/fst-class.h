 ...
 public:
  ...
  bool AddArc(int64_t s, const ArcClass& ac) final {
    ...
    Arc arc(ac.ilabel, ac.olabel, *ac.weight.GetWeight<typename Arc::Weight>(),
            ac.nextstate);
    absl::down_cast<MutableFst<Arc>*>(impl_.get())->AddArc(s, arc);
    return true;
  }

  // Warning: calling this method casts the FST to a mutable FST.
  int64_t AddState() final {
    return absl::down_cast<MutableFst<Arc>*>(impl_.get())->AddState();
  }

  // Warning: calling this method casts the FST to a mutable FST.
  void AddStates(size_t n) final {
    return absl::down_cast<MutableFst<Arc>*>(impl_.get())->AddStates(n);
  }
  ...
  bool DeleteArcs(int64_t s, size_t n) final {
    if (!ValidStateId(s)) return false;
    absl::down_cast<MutableFst<Arc>*>(impl_.get())->DeleteArcs(s, n);
    return true;
  }
  ...
  bool DeleteArcs(int64_t s) final {
    if (!ValidStateId(s)) return false;
    absl::down_cast<MutableFst<Arc>*>(impl_.get())->DeleteArcs(s);
    return true;
  }
  ...
  bool DeleteStates(const std::vector<int64_t>& dstates) final {
    ...
    absl::down_cast<MutableFst<Arc>*>(impl_.get())->DeleteStates(typed_dstates);
    return true;
  }

  // Warning: calling this method casts the FST to a mutable FST.
  void DeleteStates() final {
    absl::down_cast<MutableFst<Arc>*>(impl_.get())->DeleteStates();
  }
  ...
  SymbolTable* MutableInputSymbols() final {
    return absl::down_cast<MutableFst<Arc>*>(impl_.get())
        ->MutableInputSymbols();
  }
  ...
  int64_t NumStates() const final {
    return absl::down_cast<MutableFst<Arc>*>(impl_.get())->NumStates();
  }
  ...
  bool ReserveArcs(int64_t s, size_t n) final {
    if (!ValidStateId(s)) return false;
    absl::down_cast<MutableFst<Arc>*>(impl_.get())->ReserveArcs(s, n);
    return true;
  }

  // Warning: calling this method casts the FST to a mutable FST.
  void ReserveStates(int64_t n) final {
    absl::down_cast<MutableFst<Arc>*>(impl_.get())->ReserveStates(n);
  }
  ...
  void SetInputSymbols(const SymbolTable* isyms) final {
    absl::down_cast<MutableFst<Arc>*>(impl_.get())->SetInputSymbols(isyms);
  }

  // Warning: calling this method casts the FST to a mutable FST.
  bool SetFinal(int64_t s, const WeightClass& weight) final {
    if (!ValidStateId(s)) return false;
    absl::down_cast<MutableFst<Arc>*>(impl_.get())
  ...
  void SetOutputSymbols(const SymbolTable* osyms) final {
    absl::down_cast<MutableFst<Arc>*>(impl_.get())->SetOutputSymbols(osyms);
  }

  // Warning: calling this method casts the FST to a mutable FST.
  void SetProperties(uint64_t props, uint64_t mask) final {
    absl::down_cast<MutableFst<Arc>*>(impl_.get())->SetProperties(props, mask);
  }

  // Warning: calling this method casts the FST to a mutable FST.
  bool SetStart(int64_t s) final {
    if (!ValidStateId(s)) return false;
    absl::down_cast<MutableFst<Arc>*>(impl_.get())->SetStart(s);
    return true;
  }
  ...
  const Fst<Arc>* GetFst() const {
    if (Arc::Type() != ArcType()) {
      ...
      FstClassImpl<Arc>* typed_impl =
          absl::down_cast<FstClassImpl<Arc>*>(impl_.get());
...
class MutableFstClass : public FstClass {
 public:
  ...
  MutableFst<Arc>* GetMutableFst() {
    ...
    MutableFst<Arc>* mfst = absl::down_cast<MutableFst<Arc>*>(fst);
    return mfst;
  }
